...
#######Subracts each element in one tuple by the corresponding element in the other tuple#######
#######Suggestions generated by ChatGPT#######
    for tup in adc_list:
        diff = tuple(b - a for a, b in zip(adc_list[0], adc_list[1]))
    return diff
